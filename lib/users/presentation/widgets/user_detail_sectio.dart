...
final expandedDetailProvider = StateProvider<Map<String, bool>>((ref) => {});
...
class UserDetailSection extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final expandedState = ref.watch(expandedDetailProvider);
    final expandedNotifier = ref.read(expandedDetailProvider.notifier);
        ...
        children: [
          ...
          if (isExpanded)
            Padding(
              ...
              child: Builder(
                builder: (context) {
                  if (sectionState is AsyncLoading) {
                    return const Center(
                      child: Padding(
